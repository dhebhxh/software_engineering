...
function basicBlockResponse(a, msg) {
    if (msg === "left" || msg === "right") {
        ...
        if (msg === "bottom") {
            ...
            if (
                a.controllerManager &&
                a.controllerManager.currentControlComponent &&
...
function dynDynBlockResponse(a, b, msg) {
    ...
    if(msg === "a_on_b") {
       ...
       if (a.controllerManager?.currentControlComponent?.abilityCondition) {
            a.controllerManager.currentControlComponent.abilityCondition["isOnGround"] = true;
        }
        a.isOnGround = true;
    } else if(msg === "b_on_a") {
        ...
        if (b.controllerManager?.currentControlComponent?.abilityCondition) {
