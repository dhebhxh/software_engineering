...
export class Level1 extends BaseLevel {
    constructor() {
        ...
        this.entities.add(new Ground(0, 0, sketch.width, 80));
        this.entities.add(new Ground(600, 80, 200, 150));
        this.entities.add(new Home(700, 80+150, 50, 70));
        this.entities.add(new Wall(-10, 0, 15, sketch.height));
        this.entities.add(new Wall(900, 0, sketch.width-900, sketch.height));
